...
@section('breadcrumb')
  ...
  <li><a href="{{ url('/tarificador/extensiones') }}"><i class="fa fa-money"></i> Tarificador</a></li>
...
<section class="content">
  ...
  <div class="row">
    @php
      ...
      $columns[] = array('data' => 'consumption_string', 'title' => 'Tiempo a Facturar', 'type' => 'date');
...
@section('script')
  @php
    //script datatable
    AdminLTE::DataTable_Script("dataTable", $columns, url("/tarificador/extensiones/datatable"), 50, 1);
  @endphp
