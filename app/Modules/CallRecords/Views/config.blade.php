 ...
 * @subpackage  app/Modules/CallRecords/Views
...
@section('breadcrumb')
  ...
  <li><a href="{{ url('/callrecords') }}"><i class="fa fa-microphone"></i> Call Records</a></li>
...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
      <form id="config" action="{{ action('\App\Modules\CallRecords\Controllers\ConfigController@putEntity') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
        {{ method_field('PUT') }}
        {{ csrf_field() }}
        ...
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            @php
              ...
              if ($errors_found)
                $group = App\Modules\CallRecords\Controllers\ConfigController::groupHasErrors($inputs, $errors);
            @endphp
            <li{{ $group == 0 ? " class=active" : "" }}><a href="#principal" data-toggle="tab">Configuración</a></li>
          </ul>
...
@section('jquery_onload')
  ...
  {{ AdminLTE::Menu_Active("callrecords_config") }}
@endsection
